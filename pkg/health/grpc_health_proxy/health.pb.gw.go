...
/*
Package grpc_health_proxy is a reverse proxy.
...
var (
	pattern_Health_Check_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"healthz", "service"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Health_Check_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"healthz"}, "", runtime.AssumeColonVerbOpt(true)))
)
